          ...
          if (progress >= 100) {
            ...
            setTimeout(() => {
              const mockResult = {
                ...
                features: {
                  "MDVP:Fo(Hz)": Math.random(),
                  "MDVP:Fhi(Hz)": Math.random(),
                  "MDVP:Flo(Hz)": Math.random(),
                  "MDVP:Jitter(%)": Math.random(),
                  "MDVP:Jitter(Abs)": Math.random(),
                  "MDVP:RAP": Math.random(),
                  "MDVP:PPQ": Math.random(),
                  "Jitter:DDP": Math.random(),
                  "MDVP:Shimmer": Math.random(),
                  "MDVP:Shimmer(dB)": Math.random(),
                  "Shimmer:APQ3": Math.random(),
                  "Shimmer:APQ5": Math.random(),
                  "MDVP:APQ": Math.random(),
                  "Shimmer:DDA": Math.random(),
                  NHR: Math.random(),
                  HNR: Math.random(),
                  RPDE: Math.random(),
                  DFA: Math.random(),
